 ...
 *
 * Root `playwright.config.ts` already declares a project named "books" with the
 * right testDir and baseURL. This file is what gets loaded when you run
 * `pnpm test --config=products/books/playwright.config.ts` or when you target
 * just this product through `--project=books`.
 *
